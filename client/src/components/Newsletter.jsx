...
const Newsletter = () => {
    return (
        <motion.div
            ...
            className="flex flex-col items-center justify-center text-center space-y-2 mx-mid:px-4 my-10 mb-40 ">
            ...
            <motion.p
                ...
                className="md:text-lg text-gray-500/70 pb-8"> Subscribe to get the latest offers, new arrivals, and exclusive discounts
            </motion.p>
